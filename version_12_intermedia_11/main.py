# Versión intermedia: se agrega el orquestador de compilación por carpeta.
# Está basado en el main.py final para que el flujo de ejecución sea el mismo:
# leer .c, generar AST, visitar el AST y escribir .ll en codigo_ll/.
import os
